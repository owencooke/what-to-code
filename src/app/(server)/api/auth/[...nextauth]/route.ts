...
import { getUser } from "@/app/(server)/lib/github/user";
import { createUserIfNotExist } from "@/app/(server)/lib/db/query/user";
import { sendWelcomeEmail } from "@/app/(server)/lib/email/welcome";
